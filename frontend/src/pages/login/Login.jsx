...
const Login = () => {
	...
	// useEffect(()=>{console.log(`${username} Here ${password}`)}, [username, password])
			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0'>
				...
				<form >
					<div>
						...
						<input type='text' placeholder='Enter username' className='w-full input input-bordered h-10' onChange={(e)=>{setUsername(prev=>e.target.value)}}/>
					</div>
